...
export const ZH: Record<string, string> = {
  ...
  "All tasks": "全部任务", "Task list": "任务列表", "Cluster by JD": "按岗位聚合", "Role & project": "岗位与项目",
  "Link candidate": "关联候选人", "candidates": "位候选人", "Round": "轮次", "Created": "创建时间",
  "Resume": "简历", "View resume": "简历", "Candidate resume": "候选人简历", "Target role": "目标岗位",
  ...
  "Case not found.": "未找到该案例。", "'s plan": "的方案", "Candidate detail": "候选人详情",
  "Assessment plan": "测评计划", "Submission": "提交内容", "Comprehensive evaluation": "综合评估", "Evaluation result": "评估结果",
  ...
  "No assessment questions yet. Click \"Add assessment question\" to get started.": "暂无测评题目，点击「添加测评题目」开始。",
  "Add assessment question": "添加测评题目", "adjustable for this candidate only": "仅可为当前候选人调整",
  "Send to candidate": "发送给候选人", "Edit question": "编辑题目", "Delete question": "删除题目",
  "Question deleted.": "题目已删除。", "Editing questions is coming in a later phase.": "编辑功能将在后续阶段上线。",
  "Deliverable files": "交付物文件", "Missing": "缺失",
  "Confirm finalize": "确认定稿", "This locks the scores in and creates a result ready to publish.": "这将锁定当前分数并生成可发布的结果。",
  "Generate assessment question": "生成测评题目", "Select a preset question first.": "请先选择预设题目。",
  "Enter a test focus first.": "请先填写测试重点。", "Tell me which capability you'd like to focus on testing.": "请告诉我你想侧重测试哪部分能力。",
  "Based on this role's requirements, consider focusing on:": "根据该岗位要求，建议你可以重点测试这些能力：",
  "Question content": "题目内容", "Scoring rubric": "评分标准", "Save changes": "保存修改", "Confirm generate": "确认生成",
  "Written test question and scoring rubric generated.": "笔试题目及评分标准已生成。", "Assessment question generated.": "测评题目已添加。",
  "— Select a preset question —": "— 选择预设题目 —",
  "Approved v1; edits below only apply to this candidate's draft and never change the role preset.": "已批准 v1；下方修改仅作用于当前候选人草稿，不会影响岗位预设。",
  "From Question Bank": "从题库选择", "AI-generated": "AI 生成", "Test focus": "测试重点",
  "Generate with AI": "AI 生成题目", "Generating…": "生成中…", "AI generation failed. Please try again.": "AI 生成失败，请重试。",
  "No linked JD/resume text for this candidate yet — generating from the role title alone.": "该候选人暂无关联的岗位JD/简历原文，将仅基于岗位名称生成。",
  "Set a deadline first.": "请先设置截止时间。", "Invitation sent to candidate.": "已发送给候选人。", "Confirm send": "确认发送",
  "Cancel": "取消", "Assessment result": "测评结果", "No result has been returned yet.": "尚未返回测评结果。",
  "Resume preview is linked to the shared candidate record.": "简历预览来自共享候选人档案。",
  "Professional summary": "职业概述", "Experience": "工作经历", "Core skills": "核心技能", "Education": "教育背景",
  ...
  "Preview form": "预览表单", "Sending…": "发送中…",
  "This is exactly what the candidate will see when they open the form link.": "以下就是候选人打开表单链接后看到的内容。",
  "Candidate's answer": "候选人作答区", "The candidate will type their answer here.": "候选人将在此处填写作答内容。",
  "Form link": "表单链接", "Copy": "复制", "Link copied.": "链接已复制。",
  "An email containing this link has been sent to": "已将包含该链接的邮件发送给",
