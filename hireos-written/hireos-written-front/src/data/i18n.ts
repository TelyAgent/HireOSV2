...
export const ZH: Record<string, string> = {
  ...
  "Other open roles": "其他在招岗位",
  "No assessment projects yet.": "暂无测评项目。",
  "No comparisons yet.": "暂无候选人对比。",
  "Start one from a role group on My Tasks once candidates have scores.": "候选人有评分后，可在「我的任务」按岗位聚合中发起对比。",
  ...
  "Recipient email": "收件人邮箱", "Candidate's email": "候选人邮箱",
  "Defaults to the email on this candidate's resume — edit if it's wrong or you want to send elsewhere.": "默认取自该候选人简历中的邮箱，如有误或需要发送到其他地址可在此修改。",
  "Enter a valid recipient email first.": "请先填写有效的收件人邮箱。",
  ...
  "The email will be sent from the corporate mailbox configured in": "邮件将通过以下位置配置的企业邮箱发出：",
  "Could not send the email automatically": "未能自动发送邮件",
  "Copy the link above and send it to the candidate yourself, or": "请复制上方链接自行发送给候选人，或",
  "connect a mailbox in Settings": "在设置中连接一个邮箱账号",
  "Corporate mailbox": "企业邮箱",
  "Used to send real assessment invitation emails to candidates.": "用于向候选人发送真实的测评邀请邮件。",
  "No mailbox account connected yet.": "尚未连接任何邮箱账号。",
  "Connect one to send real invitation emails instead of a simulated placeholder.": "连接一个邮箱账号后，即可发送真实邀请邮件，而不再是模拟占位。",
  "Add mailbox account": "添加邮箱账号", "Edit mailbox account": "编辑邮箱账号",
  "Display name": "显示名称", "e.g. HR Recruiting": "例如：招聘专员",
  "Provider": "服务商", "Mailbox address": "邮箱地址", "App password": "授权码/应用密码",
  "Required": "必填", "Leave blank to keep the current password": "留空则保持原授权码不变",
  "This is a mailbox app password, not your normal login password.": "这里填写的是邮箱的授权码/应用专用密码，不是登录密码。",
  "How to get one": "如何获取", "Hide": "隐藏", "Show": "显示",
  "Hide advanced SMTP settings": "隐藏高级 SMTP 设置", "Show advanced SMTP settings": "显示高级 SMTP 设置",
  "SMTP host": "SMTP 主机", "SMTP port": "SMTP 端口", "Use TLS (usually port 465)": "使用 TLS（通常为 465 端口）",
  "Test connectivity": "测试连通性", "Testing…": "测试中…", "Connected successfully.": "连接成功。",
  "Save and verify": "验证并保存", "Saving…": "保存中…",
  "Enter the mailbox address and app password first.": "请先填写邮箱地址和授权码。",
  "Connection test failed.": "连接测试失败。", "Could not save this mailbox.": "保存该邮箱失败。",
  "Mailbox account saved.": "邮箱账号已保存。", "Mailbox account removed.": "邮箱账号已移除。",
